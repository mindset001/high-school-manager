...
const ResultNames: React.FC = () => {
  ...
  const handleFileChange = (event: { target: any }) => {
    ...
    const fileLength =
      file.name.length > 10
        ? `${file.name.split(".")[0].slice(0, 10)}...${file.name
            .split(".")
            .pop()}`
        : file.name;
    setFileName(file ? fileLength : "No file chosen");
  };
  // GETTING CLASS Data
                ...
                <div className="block md:hidden grow">
                  <div className="student-names-list-container-mheader">
                    ...
                    <div className="student-names-list-container-mheader-button flex flex-row">
                      ...
                      <div className={`results-options ${optionsToggle? "flex" : "hidden md:flex"}`} >
                        <button >Select Subject <span className="ml-3 text-[12px]">&#9660;</span></button>
                        <button onClick={() => setOptionsToggle(false)}>Download Template</button>

                        <div className="file-upload text-base md:text-sm lg:text-base">
                          <label
                            htmlFor="file-input"
                            className="custom-file-label text-base md:text-sm lg:text-base"
                          >
                        ...
                        <button
                          ...
                          className={
                            fileName === "No file chosen"
                              ...
                              : "cursor-pointer bg-[#4B9CC2] hover:bg-[#4B9CC2]/70 text-white"
                          }
                        >
                          Upload Result
                        </button>
